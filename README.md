This program is proudly written without any help of AI/code completion. Going back to ancient time and use stackoverflow and google instead.

This program is to test out my program design capability in c++, along with getting clear with some concepts in C++.
